...
/**
 * @notice RobotAbility1 NFT contract
 */
contract RobotAbility1 is Initializable, RobotPart {
    constructor() initializer {}

    /**
     * @notice Initialize the Robot Ability1 NFT contract
    ...
    function initialize(
        ...
        __ERC721_init('Robot Ability 1', 'RobotAbility1');
        admin = _admin;
        powerDecimals = 0;
