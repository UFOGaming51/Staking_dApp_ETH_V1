...
/**
 * @notice RobotAbility2 NFT contract
 */
contract RobotAbility2 is Initializable, RobotPart {
    constructor() initializer {}

    /**
     * @notice Initialize the Robot Ability2 NFT contract
    ...
    function initialize(
        ...
        __ERC721_init('Robot Ability 1', 'RobotPassive2');
        admin = _admin;
        powerDecimals = 0;
