 ...
 */
contract RobotAbilityMelee is Initializable, RobotPart {
    constructor() initializer {}

    /**
     * @notice Initialize the Robot Ability Melee NFT contract
    ...
    function initialize(
        ...
        __ERC721_init('Robot Ability Melee', 'RobotAbilityMelee');
        admin = _admin;
        powerDecimals = 0;
